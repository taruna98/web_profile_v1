    ...
    <div class="container ff-inter">
        <div class="d-flex justify-content-between text-white">
            <div class="d-flex align-items-center">
                <a class="text-decoration-none text-white" href="<?= $this->baseUrl ?>?proid/<?= $this->proId ?>"><b>Home</b></a> &nbsp;/ Portfolio
            </div>
            <div class="d-flex">
        ...
        <div class="row row-portfolio mt-4">
            <?php for ($i = 0; $i < count($response); $i++) { ?>
                <div class="col-lg-4 col-sm-6 my-3 port-item">
                    <!-- portfolio items -->
                    <div class="card">
                        <img src="assets/img/<?= $response[$i]['cod'] ?>-port-<?= $response[$i]['id'] ?>-<?= $i + 1 ?>.jpg" class="card-img-top" alt="th-portfolio">
