<?php require('template/layout_top.php') ?>
    <!-- Article Header -->
    <header class="art-head" id="art-head" style="background-image: url('assets/img/bg-article.png')">
        <div class="container">
            <div class="masthead-heading text-uppercase"><?= $response['ttl'] ?></div>
            <div class="masthead-subheading"><a class="text-decoration-none text-white" href=""><b>Home</b></a> / Article Detail</div>
        </div>
    </header>
    <!-- Article Body -->
